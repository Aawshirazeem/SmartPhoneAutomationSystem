                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>Sign Up into SPAS</strong>  </h1>
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                            		...
                            		<p>Enter the values of below given fields</p>
                        		</div>
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="" method="post" class="login-form">
									...
									<div class="form-group">
			                        	...
			                        	<input type="text" name="form-username" placeholder=" Phone No ..." class="form-username form-control" id="form-username">
			                        </div>
									<div class="form-group">
			                        ...
			                        <div class="form-group">
			                        	<label class="sr-only" for="form-password">User Name</label>
			                        	<input type="password" name="form-password" placeholder="User Name..." class="form-password form-control" id="form-password">
			                        </div>
									<div class="form-group">
